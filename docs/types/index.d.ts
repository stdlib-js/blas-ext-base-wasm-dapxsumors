...
/**
* Interface describing a `dapxsumors` WebAssembly module.
*/
...
interface Routine extends ModuleWrapper {
	...
	*
	* var out = dapxsumors.main( 3, 5.0, x, 1 );
	* // returns 16.0
	*/
	...
	*
	* var out = dapxsumors.ndarray( 4, 5.0, x, 2, 1 );
	* // returns 25.0
	*/
