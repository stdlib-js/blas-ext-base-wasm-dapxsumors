...
*
* // Perform operation:
* var sum = dapxsumors.main( 3, 5.0, x, 1 );
* // returns 16.0
*
* @example
* var Float64Array = require( '@stdlib/array-float64' );
...
*
* // Perform operation:
* var sum = dapxsumors.ndarray( 4, 5.0, x, 2, 1 );
* // returns 25.0
*/
function Routine() {
...
* // returns 16.0
*/
setReadOnly( Routine.prototype, 'main', function dapxsumors( N, alpha, x, strideX ) {
...
* // returns 25.0
*/
setReadOnly( Routine.prototype, 'ndarray', function dapxsumors( N, alpha, x, strideX, offsetX ) {
	var ptrs;
	var p0;
