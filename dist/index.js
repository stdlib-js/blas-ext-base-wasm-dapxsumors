...
var S=require('@stdlib/assert-is-wasm-memory/dist'),q=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),g=require('@stdlib/utils-inherit/dist'),m=require('@stdlib/wasm-module-wrapper/dist'),j=require('@stdlib/error-tools-fmtprodmsg/dist'),z=y();function a(e){if(!(this instanceof a))return new a(e);if(!S(e))throw new TypeError(j('nullH0',e));return m.call(this,z,e,{env:{memory:e}}),this}g(a,m);q(a.prototype,"main",function(r,i,s,t){return this._instance.exports.stdlib_strided_dapxsumors(r,i,s,t)});q(a.prototype,"ndarray",function(r,i,s,t,d){return this._instance.exports.stdlib_strided_dapxsumors_ndarray(r,i,s,t,d)});f.exports=a
